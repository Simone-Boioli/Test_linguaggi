...
public class CercaProdotto extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		/*
 		 *  Selezionato "tutte le categorie" e non è stato inserito niente nel campo di testo
 		 */
		if(prodottoU.equals("tutteLeCategorie") && ricercaU.equals("")){
			...
			for(int j = 0; j < len1; j++){ 
				...
				// in posizione 0 ci sarò l'articolo
		...
		/*
 		 * E' stata selezionata una categoria e non è stato inserito nessun testo
 		 */
		...
		/*
 		*   Selezionato "tutte le categorie" e è stata inserita la marca del prodotto
 		*/ 
		}else if(prodottoU.equals("tutteLeCategorie") && !ricercaU.equals("")){
