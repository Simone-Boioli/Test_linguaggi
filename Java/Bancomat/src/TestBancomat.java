...
public class TestBancomat extends TestCase {
	...
	public void testPrelievo() {
		...
		assertEquals(bancomat.prelievo(100.0), 100.0);  // saldo = 500, max = 100-->ok
		assertEquals(bancomat.prelievo(550.0), 0.0);    //saldo = 500, prelievo 550-->errato
		assertEquals(bancomat.prelievo(50.0), 0.0);     // oltre il limite della giornata
		...
		assertEquals(bancomat.prelievo(10.0), 0.0);  //non esiste nel conto corrente
